...
G_2866_well = G_2866_well %>% filter(datetime >= "2016-10-01 00:00:00")
...
time_seq <- as.data.frame(seq(as.POSIXct("2007-10-01 01:00:00"), as.POSIXct("2018-06-08 09:00:00"), "hour"))
...
# create full sequence of dates
time_seq <- as.data.frame(seq(as.POSIXct("2007-10-01 01:00:00"), as.POSIXct("2018-03-26 10:00:00"), "hour"))
names(time_seq) <- c("datetime")
...
# create full sequence of dates
time_seq <- as.data.frame(seq(as.POSIXct("2007-10-01 01:00:00"), as.POSIXct("2018-06-04 10:00:00"), "hour"))
names(time_seq) <- c("datetime")
...
# create full sequence of dates
time_seq <- as.data.frame(seq(as.POSIXct("2007-10-01 01:00:00"), as.POSIXct("2018-04-09 12:00:00"), "hour"))
names(time_seq) <- c("datetime")
...
hour(G_2147_rain$datetime) <- hour(G_2147_rain$Date) # adds date to datetime
...
# fwrite(Well_merge, '../Outputs/combined_well.csv')
# 
